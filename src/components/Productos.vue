      ...
      <div class="card col m-3" v-for="p in productos" :key="p.ingredientes">
        <div>
          ...
          <div class="d-flex justify-content-between mb-2">
            <button v-if="permiso" @click="editar = true; Editar = p; proRe = true" class="btn-secundario px-2">Editar</button>
            <button v-if="permiso" type="submit" @click="eliminar(p._id)" class="btn-terciario px-2">Eliminar</button>
          </div>
      </div>
    </div>
    <ModalPPDM
